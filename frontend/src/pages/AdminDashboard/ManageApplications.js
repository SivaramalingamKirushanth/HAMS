              ...
              {applications.map((app) => (
                <tr key={app.id} onClick={() => openModal(app)} className="table-row-interactive">
                  ...
                  <td className="actions-cell">
                    {app.status === 'Pending' ? (
                      <>
                        <button onClick={(e) => updateStatus(app.id, 'Approved', e)} className="btn-action btn-approve">Approve</button>
                        <button onClick={(e) => updateStatus(app.id, 'Rejected', e)} className="btn-action btn-reject">Reject</button>
                      </>
                    ) : (
        ...
        <div className="modal-overlay" onClick={closeModal}>
          <div className="modal-content" onClick={e => e.stopPropagation()}>
            ...
            <div className="modal-body">
              ...
              <div className="modal-signature-section">
              ...
              <div className="modal-admin-section" style={{ border: '1px solid #000', padding: '20px', marginTop: '20px', backgroundColor: '#fff', color: '#000' }}>
                ...
                <div style={{ display: 'grid', gridTemplateColumns: 'auto 1fr auto 1fr auto 1fr', gap: '10px', marginBottom: '20px', alignItems: 'center' }}>
                  ...
                  <input type="text" value={adminData.roomNo} onChange={e => setAdminData({...adminData, roomNo: e.target.value})} disabled={selectedApp.status !== 'Pending'} style={{ border: 'none', borderBottom: '1px dotted #000', outline: 'none', width: '100%', backgroundColor: 'transparent' }} />
                </div>
